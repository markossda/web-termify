          ...
          <div class="hd">
            ...
            <xsl:choose>
              ...
              <xsl:when test="sitemap:sitemapindex">
                <p>This sitemap index contains <strong><xsl:value-of select="count(sitemap:sitemapindex/sitemap:sitemap)"/></strong> sitemap files for <a href="https://protermify.com">protermify.com</a></p>
                <div class="meta">
                  <span>Last updated: <b><xsl:value-of select="sitemap:sitemapindex/sitemap:sitemap[1]/sitemap:lastmod"/></b></span>
                  <span>Protocol: <b>Sitemaps 0.9</b></span>
                </div>
              </xsl:when>
              <xsl:otherwise>
                <p>This file does not contain a valid sitemap payload.</p>
              </xsl:otherwise>
            </xsl:choose>
          </div>
          <xsl:choose>
            ...
            <xsl:otherwise>
              <table>
                ...
                <tbody>
                  <tr>
                    <td>No sitemap entries found.</td>
                  </tr>
                </tbody>
              </table>
            </xsl:otherwise>
